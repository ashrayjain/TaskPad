...
public:
	...
	bool             setNoParameterMessage(std::string command, bool&flag, std::string regexTemplate){return Interpreter_base::setNoParameterMessage(command,flag, regexTemplate);}
